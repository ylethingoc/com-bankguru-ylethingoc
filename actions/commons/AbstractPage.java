...
public abstract class AbstractPage {
    ...
    public NewCustomerPageObject openNewCustomerPage(WebDriver driver) {
        waitForElementVisible(driver, AbstractPageUI.NEW_CUSTOMER_TEXT_AREA);
        clickToElement(driver, AbstractPageUI.NEW_CUSTOMER_TEXT_AREA);
        return PageGeneratorManager.getNewCustomerPage(driver);
    }

    public NewAccountPageObject openNewAccountPage(WebDriver driver) {
        waitForElementVisible(driver, AbstractPageUI.NEW_ACCOUNT_TEXT_AREA);
        clickToElement(driver, AbstractPageUI.NEW_ACCOUNT_TEXT_AREA);
        return PageGeneratorManager.getNewAccountPage(driver);
    }

    public DepositPageObject openDepositPage(WebDriver driver) {
        waitForElementVisible(driver, AbstractPageUI.DEPOSIT_TEXT_AREA);
        clickToElement(driver, AbstractPageUI.DEPOSIT_TEXT_AREA);
        return PageGeneratorManager.getDepositPage(driver);
    }

    public WithdrawalPageObject openWithdrawalPage(WebDriver driver) {
        waitForElementVisible(driver, AbstractPageUI.WITHDRAWAL_TEXT_AREA);
        clickToElement(driver, AbstractPageUI.WITHDRAWAL_TEXT_AREA);
        return PageGeneratorManager.getWithdrawalPage(driver);
    }
    ...
    public void waitForElementClickable(WebDriver driver, String locator, String... dynamicValue) {
        explicitWait = new WebDriverWait(driver, longTimeout);
        explicitWait.until(ExpectedConditions.elementToBeClickable(byXpath(castRestParameter(locator, dynamicValue))));
    }
